...
class CreateStaffRegisterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('staff_register', function (Blueprint $table) {
            $table->integer('staffregister_id', true);
            ...
            $table->index(['staffregister_id', 'staff_fullname', 'employee_id', 'staff_phone', 'staff_email', 'staff_position', 'staff_department', 'staff_group', 'username', 'password', 'technician_group', 'technician_rank', 'job_ability', 'staffregistercreated_by', 'staffregistercreated_at', 'staffregisterlastmodify_by', 'staffregisterlastmodify_at'], 'staffregister_id');
        });
    }
    ...
    {
        Schema::dropIfExists('staff_register');
    }
}
